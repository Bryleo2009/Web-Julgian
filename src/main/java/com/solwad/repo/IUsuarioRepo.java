...
public interface IUsuarioRepo extends CrudRepository<Usuario, Integer>{
	...
	@Query(value="INSERT INTO usuario\r\n"
			...
			+ "id_rol)\r\n"
			+ "VALUES\r\n"
			+ "(true,'$2a$10$Zmb81nI58LGVRk.CXYk5/.NXMp3gV3LCKTmZKJk3bBaqrrIzg3CEe','NULL','00000000',1);", nativeQuery = true)//12345
	void nulo();
	@Modifying
	@Query(value="INSERT INTO usuario\r\n"
			+ "(estado_user,\r\n"
			...
			+ "id_rol)\r\n"
			+ "VALUES\r\n"
			+ "(true,'$2a$10$Zmb81nI58LGVRk.CXYk5/.NXMp3gV3LCKTmZKJk3bBaqrrIzg3CEe','admin','71850926',1);", nativeQuery = true)//12345
	void prueba();
